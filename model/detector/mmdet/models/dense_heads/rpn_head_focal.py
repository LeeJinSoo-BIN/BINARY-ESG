...
from .anchor_head_focal import AnchorHeadFocalNet


@HEADS.register_module()
class RPNHeadFocalNet(AnchorHeadFocalNet):
    """RPN head.
    ...
    def __init__(self,
        ...
        super(RPNHeadFocalNet, self).__init__(
    ...
    def loss(self,
        ...
        """
        losses = super(RPNHeadFocalNet, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
